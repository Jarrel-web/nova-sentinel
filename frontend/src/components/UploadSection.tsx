...
const UploadSection = () => {
  ...
  return (
    <section className="py-16 md:py-24 px-6 scroll-mt-20" id="upload">
      <div className="container max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
            Drop your compliance policy or document below to start analyzing for compliance risks instantly.
          </p>
        </div>

        {/* Upload Card */}
        <Card className="p-0 shadow-card border-border/50 overflow-hidden max-w-2xl mx-auto">
